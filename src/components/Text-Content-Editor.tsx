...
export function TextContentEditor({ text, editText,newText, setNewText, handleCopy}: TextContentEditorProps) {
  if (editText) {
    return (
      <textarea
    ...
    return (
      <p
        className="text-gray-950 dark:text-white font-light tracking-tight break-all  text-(length:--text-base) select-none" onClick={handleCopy}
      >
