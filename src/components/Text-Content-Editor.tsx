...
export function TextContentEditor({ text, editText, setText }: TextContentEditorProps) {
  if (editText) {
    return (
      <textarea
        className="w-full h-28 p-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white text-base font-light tracking-tight break-words"
        value={text}
