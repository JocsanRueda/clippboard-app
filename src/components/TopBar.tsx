...
function TopBar({ deleteFunction, setFilter, filter }: TopBarProps) {
  ...
  return (
    <div className="flex justify-end items-center px-2 py-3 dark:bg-primary gap-4 my-1 mx-1 ">
      ...
      <div className={`flex items-center ${isSearchVisible ? "bg-gray-300 dark:bg-secondary text-gray-900" : ""} text-quaternary rounded-lg px-2 py-1 focus-within:ring-2 focus-within:ring-gray-400 focus-within:dark:border-tertiary overflow-hidden`}>
        <FaMagnifyingGlass
