...
export function Settings(){
  ...
  return(
    <div className="flex flex-col w-full h-full bg-gray-100 dark:bg-primary" >
      <div className="w-full grid grid-cols-3 gap-2 my-4">
        <IoArrowBackOutline className="w-5.5 h-5.5 text-gray-600 dark:text-gray-200  cursor-pointer border-width-selected border-gray-100 dark:border-none hover:border-gray-400 rounded-md  ml-1.5" onClick={() => goBack()} />
